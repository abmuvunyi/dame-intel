...
export default function GameBoard() {
  ...
  const cellSize = isInternational ? "w-10 h-10 sm:w-12 sm:h-12" : "w-14 h-14 sm:w-16 sm:h-16";
  const pieceSize = isInternational ? "w-8 h-8 sm:w-10 sm:h-10 text-xs sm:text-sm" : "w-10 h-10 sm:w-12 sm:h-12";
