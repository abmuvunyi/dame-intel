...
export default function GameBoard() {
  ...
  const squareSizeClass = is10x10 ? "w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14" : "w-14 h-14 sm:w-16 sm:h-16";
  const pieceSizeClass = is10x10 ? "w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 text-xs" : "w-10 h-10 sm:w-12 sm:h-12 text-base";
