      ...
      <div className="flex flex-col items-center justify-center h-screen space-y-4">
        ...
        <div className="flex flex-col space-y-4 pt-4 border-t border-gray-200 w-64">
          <div className="flex flex-col space-y-2 mb-2">
             ...
             >
               <option value={GameVariant.STANDARD}>8x8 Standard</option>
               <option value={GameVariant.INTERNATIONAL}>10x10 International</option>
             </select>
          </div>
          <button
          ...
          {board.map((row, r) => (
            <div key={r} className="flex">
              {row.map((cell, c) => {
                ...
                const squareSizeClass = is10x10 ? 'w-10 h-10 sm:w-12 sm:h-12' : 'w-14 h-14 sm:w-16 sm:h-16';
                const pieceSizeClass = is10x10 ? 'w-8 h-8 sm:w-10 sm:h-10' : 'w-10 h-10 sm:w-12 sm:h-12';
                const fontSizeClass = is10x10 ? 'text-sm' : 'text-base';
                ...
                return (
                  ...
                  >
                    {cell && (
                      <div className={`
                        ${pieceSizeClass} ${fontSizeClass} rounded-full shadow-md flex items-center justify-center text-white font-bold transform transition-transform hover:scale-105
